//
// Created by Poter Hsu on 2015/12/15.
//

#include "AsciiModelParserTest.h"
...
class AsciiModelParserTest : public testing::Test {
protected:
    Module<double>* model;
...
TEST_F(AsciiModelParserTest, PARSE_NON_EXIST_MODEL_SHOULD_THROW_EXCEPTION) {
    AsciiModelParser asciiModelParser("non-exist-model.tpa");
    ASSERT_THROW(model = asciiModelParser.parse<double>(), runtime_error);
}

TEST_F(AsciiModelParserTest, PARSE_CHECK_1) {
...
TEST_F(AsciiModelParserTest, PARSE_CHECK_2) {
...
TEST_F(AsciiModelParserTest, PARSE_CHECK_3) {
...
TEST_F(AsciiModelParserTest, PARSE_CHECK_4) {
...
TEST_F(AsciiModelParserTest, PARSE_CHECK_5) {
...
TEST_F(AsciiModelParserTest, PARSE_CHECK_6) {
...
TEST_F(AsciiModelParserTest, PARSE_CHECK_7) {
...
TEST_F(AsciiModelParserTest, PARSE_CHECK_8) {
...
TEST_F(AsciiModelParserTest, PARSE_CHECK_9) {
...
TEST_F(AsciiModelParserTest, PARSE_CHECK_10) {
...
TEST_F(AsciiModelParserTest, PARSE_CHECK_11) {
...
TEST_F(AsciiModelParserTest, PARSE_CHECK_12) {
...
TEST_F(AsciiModelParserTest, FORWARD_1) {
    ...
    AsciiModelParser asciiModelParser("data/model19.tpa");
    ASSERT_NO_THROW(model = asciiModelParser.parse<double>());
...
TEST_F(AsciiModelParserTest, FORWARD_2) {
    shared_ptr<Tensor<double>> input = make_shared<Tensor<double>>(vector<long>({5, 3, 5}));
    shared_ptr<Tensor<double>> output;
    ...
    AsciiModelParser asciiModelParser("data/model20.tpa");
    ASSERT_NO_THROW(model = asciiModelParser.parse<double>());
...
TEST_F(AsciiModelParserTest, FORWARD_3) {
    ...
    AsciiModelParser asciiModelParser("data/model21.tpa");
    ASSERT_NO_THROW(model = asciiModelParser.parse<double>());
    ...
    cout << "AsciiModelParserTest.FORWARD_3 elapsed: " << elapse << " (s)" << endl << endl;
